...
val LocalElevations = staticCompositionLocalOf {
    Elevations(default = 0.dp, small = 2.dp, medium = 4.dp, large = 8.dp)
}

val LocalRadius = staticCompositionLocalOf {
    Radius(default = 0.dp, small = 4.dp, medium = 8.dp, large = 16.dp)
}
...
fun BotanTheme(
    ...
    CompositionLocalProvider(
        ...
        LocalElevations provides LocalElevations.current,
